...
KEY_ALIASES: dict[str, str] = {
    ...
    # ── Auto-audit typo merges (2026-07-22, tools/species_audit.py; gated so the
    #    differing epithet is itself a typo-variant — distinct localities skipped) ──
    "anadenobolus monillicornis": "anadenobolus monilicornis",
    "androctonus amourexi": "androctonus amoreuxi",
    "androctonus australus": "androctonus australis",
    "anqasha minaperinaensis": "anqasha minaperinensis",
    "aphonopelma chalchodes": "aphonopelma chalcodes",
    "aphonopelma seemani": "aphonopelma seemanni",
    "armadillidium klugii": "armadillidium klugi",
    "asbolus varrucosus": "asbolus verrucosus",
    "brachypelma auruatum": "brachypelma auratum",
    "brachypelma boehemi": "brachypelma boehmei",
    "brachypelma boemei": "brachypelma boehmei",
    "brachypelma bohemei": "brachypelma boehemi",
    "brachypelma klassi": "brachypelma klaasi",
    "brachypelma smithii": "brachypelma smithi",
    "buthus elmoutaukili": "buthus elmoutaouakili",
    "catumiri argentinensis": "catumiri argentinense",
    "catumiri argentinese": "catumiri argentinense",
    "chaetopelma oliviceum": "chaetopelma olivaceum",
    "chilobrachys discolus": "chilobrachys dyscolus",
    "chilobrachys natanicharim": "chilobrachys natanicharum",
    "cyclosternum sp cundinamarca": "cyclosternum sp cuninamarca",
    "diplocentrus spritzeri": "diplocentrus spitzeri",
    "ephebopus cyangnathus": "ephebopus cyanognathus",
    "ephebopus cyanognauthus": "ephebopus cyangnathus",
    "eresus sp balcanius": "eresus sp balcanicus",
    "eresus sp ilustris": "eresus sp illustris",
    "eresus walckanaeri": "eresus walckenaeri",
    "euathlus manicatus": "euathlus manicata",
    "euathlus sp smarged": "euathlus sp smaragd",
    "euathlus sp tigre": "euathlus sp tiger",
    "gandanameno echinata": "gandanameno enchinata",
    "hapalopus sp colombian": "hapalopus sp colombia",
    "hapalopus sp columbia": "hapalopus sp colombia",
    "haplocosmia himalayan": "haplocosmia himalayana",
    "haplocosmia himilayana": "haplocosmia himalayan",
    "harpactira namequensis": "harpactira namaquensis",
    "heteropoda pingungensis": "heteropoda pingtungensis",
    "heteropoda venatori": "heteropoda venatoria",
    "heterothele sp villasella": "heterothele sp villosella",
    "hottentotta trilineatus": "hottentotta trillineatus",
    "ischnocolus vanandalae": "ischnocolus vanandelae",
    "kochiana brunippes": "kochiana brunnipes",
    "lasiodora difficilis": "lasiodora difficillis",
    "lasiodorides straitus": "lasiodorides striatus",
    "linothele megatheliods": "linothele megatheloides",
    "linothele megathelodies": "linothele megatheliods",
    "nhandu tripeppi": "nhandu tripepii",
    "omothymus schiodtei": "omothymus schioedtei",
    "omothymus sp valhala": "omothymus sp valhalla",
    "omothymus violacepes": "omothymus violaceopes",
    "pamphobeteus antinious": "pamphobeteus antinous",
    "pamphobeteus sp cascadafemale": "pamphobeteus sp mascarafemale",
    "pamphobeteus sp macara": "pamphobeteus sp mascara",
    "pamphobeteus sp machalafemale": "pamphobeteus sp mascarafemale",
    "pamphobeteus sp machalla": "pamphobeteus sp machala",
    "phormingochilus sp ackaya": "phormingochilus sp akcaya",
    "poecilotheria vitatta": "poecilotheria vittata",
    "porcellio boliviari": "porcellio bolivari",
    "porcellio hoffmannseggi": "porcellio hoffmannseggii",
    "psalmopoeus rednucus": "psalmopoeus reduncus",
    "pseudhapalopus sp colombian": "pseudhapalopus sp colombia",
    "pseudhapalopus sp kurzaar": "pseudhapalopus sp kurzhaar",
    "pseudocreobotra wahlbergi": "pseudocreobotra wahlbergii",
    "pseudolychas ochraceus": "pseudolychas orchraceus",
    "pterinopelma sazamai": "pterinopelma sazimai",
    "scolopendra sp sumatra": "scolopendra sp sumatran",
    "selenobrachys phillipinus": "selenobrachys philippinus",
    "selenocosmia sp kordilera": "selenocosmia sp kordillera",
    "sericopelma rubronitrens": "sericopelma rubronitens",
    "sericopelma sp cope": "sericopelma sp cop",
    "tapinauchenius sanctivicenti": "tapinauchenius sanctivincenti",
    "theraphosa aphophysis": "theraphosa apophysis",
    "theraphosinae sp cuzco": "theraphosinae sp cusco",
    "theraphosinae sp highland blue": "theraphosinae sp blue highland blue",
    "theraphosinae sp mandarin": "theraphosinae sp mandarina",
    "theraphosinae sp roatán": "theraphosinae sp roatan",
    "theraphosinae sp san miguel": "theraphosinae sp san miquel",
    "thrixopelma cyanoeolum": "thrixopelma cyaneolum",
    "thrixopelma cyanoleum": "thrixopelma cyaneolum",
    "tityopsis rolandoi": "tityopsis rolandoia",
    "tityus smithi": "tityus smithii",
    "tliltocatl epicureanum": "tliltocatl epicureanus",
    "trichorhina tormentosa": "trichorhina tomentosa",
    "trigoniulus coralinus": "trigoniulus corallinus",
}
